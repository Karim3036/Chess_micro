...
;This file has the full chess game as a 1 player game so we can add the serial to it and it should be ready for phase 2
...
Valid_Movement proc far   
    ...
    lea si,Possible_moves
    mov cx,Possible_moves_Size   ;Counter for possible moves arrays
