...
lea si,Player2_name               ;Player_name  db  15,?,15 DUP('$')
mov ax,15
mov [si],ax
inc si
mov ax,default_check
...
ChatP1:
    ...
    call recChar    ;Check F3 Not pressed 
    mov ah,Val
    cmp ah,3Dh
    jnz Noo_Exit_Chat 
    inc fromchat
...
ChatP2: 
    ...
    jmp far ptr chat2main
Noo_Exit_Chat1:  
    Move_Cursor 0,21 ;Place to read from
    ReadString P2Chat
    add bl,12
    Move_Cursor 2,bl
    DisplayStringRead P2Chat
    STRINGCOPY P2Chat,ChatVar,70
    mov cx,70
...
ChatP1in:
    ...
    call recChar    ;Check F5 Not pressed 
    mov ah,Val
    cmp ah,3Fh
    jnz Noo_Exit_Chatin 
    ;inc fromchat
...
ChatP2in: 
    ...
    jmp frominline
Noo_Exit_Chat1in:  
    movecursor 1803h ;Place to read from
    ReadString P2Chat
    ;add bl,12
    ;Move_Cursor 2,bl
    DisplayStringRead P2Chat
...
MainScreen PROC FAR
    ...
    Checkover:
     ; Exchange Names
         ...
         ;Send Name 
         STRINGCOPY Player2_name,ChatVar,15
         Mov Cx,15
         Call send
          ...
          Mov Cx,15
          Call recieve
          STRINGCOPY ChatVar,Player1_name,15
         movecursor 1405h
    ...
    Check_Send_P1:
        ...
        CMP P1_Choice,3DH  ; F3
        JZ P1StartChat

        CMP P1_Choice,3CH  ; F2
        JZ P1StartGame  
        ...
        Humm3:
            ...
            ;Messege in player2 Notification that invitation is sent
            call ClearStat
            Move_Cursor 0,23
    ...
    Check_Send_P2:
        ...
        Dummyyy:
            cmp P2_Choice,3DH   ; F3
            jz P2StartChat

            cmp P2_Choice,3CH   ; F2
            jz P2StartGame  
